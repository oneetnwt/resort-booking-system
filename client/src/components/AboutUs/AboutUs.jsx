...
function AboutUs() {
  return (
    <div className="h-screen mx-[6.25rem] grid grid-cols-2">
      ...
      <div className="flex justify-center items-center">
        <div className="relative max-w-lg">
          <p className="absolute top-0 left-0 bg-white p-[0.75rem_2rem] text-2xl font-bold text-[var(--primary-color)] rounded-[0_0_1rem_0] shadow-mdrelative max-w-lg text-left tag">
            About Us
          </p>
          <img
            src={picture}
